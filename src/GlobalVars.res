...
let isInteg = sdkUrl === "https://dev.singularitytools.net"
let isSandbox = sdkUrl === "https://checkout.sandbox.singularitytools.net"
let isProd = sdkUrl === "https://checkout.singularitytools.net"
